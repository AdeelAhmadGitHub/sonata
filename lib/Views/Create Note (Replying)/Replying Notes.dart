...
class ReplyingNotes extends StatefulWidget {
  const ReplyingNotes({Key? key}) : super(key: key);

  @override
  State<ReplyingNotes> createState() => _ReplyingNotesState();
}

class _ReplyingNotesState extends State<ReplyingNotes> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: IgnorePointer(
        ignoring:
        reply.isTextFieldEmpty.value && _replyinImage == null,
        child: InkWell(
          onTap: () async {
            try {
              await reply.createNoteReply();
              ...
              channel.stream.listen((response) {
                ...
                try {
                  ...
                  if (json != null && json['msg'] == 'your note has been posted') {
                    // Show the bottom sheet when the expected response is received
                ...
                // Explore user login when the response stream is closed (API call completed)
                reply.exploreUserLogin();
              });
            } catch (e) {
          ...
          child: Padding(
            ...
            child: Obx(() {
              return reply.isTextFieldEmpty.value &&
                  _replyinImage == null
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            controller: reply.noteBodyReply,
                            onChanged: (text) {
                              if (text.length <= 440) {
