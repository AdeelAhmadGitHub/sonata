...
class ExploreRenote extends StatefulWidget {
  const ExploreRenote({Key? key}) : super(key: key);

  @override
  State<ExploreRenote> createState() => _ExploreRenoteState();
}

class _ExploreRenoteState extends State<ExploreRenote> {
  File? _reNoteImage;
  ...
  Widget build(BuildContext context) {
    print(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>${selectedExplorePost?.userHandle}");
    return Scaffold(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          CustomText(
                                            text: selectedExplorePost?.userName,
                                          ...
                                          CustomText(
                                            text:
                                                '@${selectedExplorePost?.userHandle}',
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Flexible(
                                      child: CustomText(
                                        text: selectedExplorePost?.channelsName,
                              ...
                              CustomText(
                                text: selectedExplorePost?.noteBody,
                                fontColor: const Color(0xff444444),
                                fontSize: 16.sp,
                                fontWeight: FontWeight.w400,
                                fontFamily: "Poppins",
                              ...
                              Visibility(
                                visible: selectedExplorePost?.noteImage != null,
                                child: SizedBox(
                                  height: 16.h,
                                ),
                              ),
                              Visibility(
                                ...
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: selectedExplorePost?.noteImage !=
                                            null
                                        ? Image.network(
                                            String.fromCharCodes(base64Decode(
                                                selectedExplorePost
                              ...
                              Visibility(
                                visible:
                                    selectedExplorePost?.threadStart ?? false,
                                child: Column(
                                  children: [
                                    Center(
                                      child: SizedBox(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      CustomText(
                                                        text:
                                                            " (+${selectedExplorePost?.threadLength.toString()})",
                                                        fontColor: const Color(
                                                            0xff868686),
                                                        fontSize: 12.sp,
                                                        fontWeight:
