...
class UserRenote extends StatefulWidget {
  const UserRenote({Key? key}) : super(key: key);

  @override
  State<UserRenote> createState() => _UserRenoteState();
}

class _UserRenoteState extends State<UserRenote> {
  File? _reNoteImage;
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: selectedUserPost
                                                      ?.profileImage !=
                                                  null
                                              ? Image.network(
                                                  String.fromCharCodes(
                                                      base64Decode(selectedUserPost
                                                              ?.profileImage ??
                                                          "")),
                                                  fit: BoxFit.cover,
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          CustomText(
                                            text: selectedUserPost?.userName,
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Flexible(
                                      child: CustomText(
                                        text: selectedUserPost?.channelsName,
                              ...
                              CustomText(
                                text: selectedUserPost?.noteBody,
                                fontColor: const Color(0xff444444),
                                fontSize: 16.sp,
                                fontWeight: FontWeight.w400,
                                fontFamily: "Poppins",
                              ...
                              Visibility(
                                visible: selectedUserPost?.noteImage != null,
                                child: SizedBox(
                                  height: 16.h,
                                ),
                              ),
                              Visibility(
                                ...
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: selectedUserPost?.noteImage != null
                                        ? Image.network(
                                            String.fromCharCodes(base64Decode(
                                                selectedUserPost?.noteImage ??
                                                    "")),
                                            fit: BoxFit.cover,
                                            errorBuilder: (BuildContext context,
                                                Object exception,
                              ...
                              Visibility(
                                visible: selectedUserPost?.threadStart ?? false,
                                child: Column(
                                  children: [
                                    Center(
                                      child: SizedBox(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      CustomText(
                                                        text:
                                                            " (+${selectedUserPost?.threadLength.toString()})",
                                                        fontColor: const Color(
                                                            0xff868686),
                                                        fontSize: 12.sp,
                                                        fontWeight:
