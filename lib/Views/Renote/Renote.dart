...
class Renote extends StatefulWidget {
  const Renote({Key? key}) : super(key: key);

  @override
  State<Renote> createState() => _RenoteState();
}

class _RenoteState extends State<Renote> {
  File? _reNoteImage;
  ...
  Widget build(BuildContext context) {
    print(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>${selectedHomePost?.userHandle}");
    return Scaffold(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: selectedHomePost
                                                      ?.profileImage !=
                                                  null
                                              ? Image.network(
                                                  String.fromCharCodes(
                                                      base64Decode(selectedHomePost
                                                              ?.profileImage ??
                                                          "")),
                                                  fit: BoxFit.cover,
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          CustomText(
                                            text: selectedHomePost?.userName,
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Flexible(
                                      child: CustomText(
                                        text: selectedHomePost?.channelsName,
                              ...
                              CustomText(
                                text: selectedHomePost?.noteBody,
                                fontColor: const Color(0xff444444),
                                fontSize: 16.sp,
                                fontWeight: FontWeight.w400,
                                fontFamily: "Poppins",
                              ...
                              Visibility(
                                visible: selectedHomePost?.noteImage != null,
                                child: SizedBox(
                                  height: 16.h,
                                ),
                              ),
                              Visibility(
                                ...
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: selectedHomePost?.noteImage != null
                                        ? Image.network(
                                            String.fromCharCodes(base64Decode(
                                                selectedHomePost?.noteImage ??
                                                    "")),
                                            fit: BoxFit.cover,
                                            errorBuilder: (BuildContext context,
                                                Object exception,
                              ...
                              Visibility(
                                visible: selectedHomePost?.threadStart ?? false,
                                child: Column(
                                  children: [
                                    Center(
                                      child: SizedBox(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      CustomText(
                                                        text:
                                                            " (+${selectedHomePost?.threadLength.toString()})",
                                                        fontColor: const Color(
                                                            0xff868686),
                                                        fontSize: 12.sp,
                                                        fontWeight:
