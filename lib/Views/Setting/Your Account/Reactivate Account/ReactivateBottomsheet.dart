...
class ReactivateBottomSheet extends StatefulWidget {
  const ReactivateBottomSheet({super.key});

  @override
  _ReactivateBottomSheetState createState() => _ReactivateBottomSheetState();
}

class _ReactivateBottomSheetState extends State<ReactivateBottomSheet> {
  ...
  void _validate() {
    setState(() {
      ...
      _PasswordValidationError = auth.passContL.text.isEmpty;
    });
  }
