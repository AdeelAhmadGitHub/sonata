...
import 'Change Email/Change Email.dart';
import 'Change Password Account/Changes Password Account.dart';
              ...
              InkWell(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return const ChangePasswordAccount();
                  }));
                },
                child: Container(
                    ...
                    child: Column(
                      children: [
                        Row(
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            Image.asset("assets/icons/key-outline.png"),
                            SizedBox(
                              width: 10.w,
                            ),
                            CustomText(
                        ...
                        Row(
                          ...
                          children: [
                            CustomText(
                              text:
                                  'Change your password (Recommended every 2\n months)',
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            CustomText(
                              text:
                                  'Change Email Address associated with this account',
                              fontColor: const Color(0xff767676),
                              fontSize: 10.sp,
                              fontWeight: FontWeight.w400,
                              fontFamily: "Poppins",
