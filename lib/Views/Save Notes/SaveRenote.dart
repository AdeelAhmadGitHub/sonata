...
import 'package:sonata/Controllers/SavedNoteController/SaveNoteController.dart';
...
class SaveRenote extends StatefulWidget {
  const SaveRenote({Key? key}) : super(key: key);

  @override
  State<SaveRenote> createState() => _SaveRenoteState();
}

class _SaveRenoteState extends State<SaveRenote> {
  File? _reNoteImage;
  String selectedValue = 'value1';
  bool isExpanded = false;
  final FocusNode _focusNode = FocusNode();
  final reNote = Get.put(SavedNotesController());
  final homeNote = Get.put(HomeController());
  var auth = Get.find<AuthController>();
  var piechart = Get.put(PieChartController());

  @override
  Widget build(BuildContext context) {
    print(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>${selectedSavePost?.userHandle}");
    return Scaffold(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            controller: reNote.noteBodyRenote,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: selectedSavePost
                                                      ?.profileImage !=
                                                  null
                                              ? Image.network(
                                                  String.fromCharCodes(
                                                      base64Decode(selectedSavePost
                                                              ?.profileImage ??
                                                          "")),
                                                  fit: BoxFit.cover,
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          CustomText(
                                            text: selectedSavePost?.userName,
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    CustomText(
                                      text: selectedSavePost?.channelsName,
                              ...
                              CustomText(
                                text: selectedSavePost?.noteBody,
                                fontColor: const Color(0xff444444),
                                fontSize: 16.sp,
                                fontWeight: FontWeight.w400,
                                fontFamily: "Poppins",
                              ...
                              Visibility(
                                visible: selectedSavePost?.noteImage != null,
                                child: SizedBox(
                                  height: 16.h,
                                ),
                              ),
                              Visibility(
                                ...
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: selectedSavePost?.noteImage != null
                                        ? Image.network(
                                            String.fromCharCodes(base64Decode(
                                                selectedSavePost?.noteImage ??
                                                    "")),
                                            fit: BoxFit.cover,
                                            errorBuilder: (BuildContext context,
                                                Object exception,
                              ...
                              Visibility(
                                visible: selectedSavePost?.threadStart ?? false,
                                child: Column(
                                  children: [
                                    Center(
                                      child: SizedBox(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      CustomText(
                                                        text:
                                                            " (+${selectedSavePost?.threadLength.toString()})",
                                                        fontColor: const Color(
                                                            0xff868686),
                                                        fontSize: 12.sp,
                                                        fontWeight:
  ...
  void _openCameraProfile(BuildContext context) async {
    ...
    if (mounted && pickedFile != null) {
      setState(() {
        ...
        homeNote.uploadImage(imageFile, imageName);
